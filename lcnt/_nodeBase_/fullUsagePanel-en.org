...
** 4) bisosLcntSetup.sh -i usgBposLcntBasesSetup -- Uses usgLcntBpo and links it to /de/sys/lcnt/lgpc
** 5) You then need to maintain usgLcntBpo to link to individual pip_lcnt-s of interest.
**
