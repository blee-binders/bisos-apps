...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]] [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-apps/lcnt/lcntBPOs/_nodeBase_")][@ ~lcntBPOs~ @]]  [[elisp:(org-cycle)][| *=* |]] ::  <<Next Manage BPO LCNTs>> [[elisp:(org-shifttab)][<)]] E|
####+END
