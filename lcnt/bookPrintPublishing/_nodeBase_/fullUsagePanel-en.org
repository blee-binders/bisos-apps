...
** B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Obtaining LLCN" :anchor "" :extraInfo "Library of Congress Control Number"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Obtaining LLCN:* |]]  Library of Congress Control Number  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
**  llcn.loc.gov
** B|
...
** PLPC nu should become PLPC-120033-b1
** B|
