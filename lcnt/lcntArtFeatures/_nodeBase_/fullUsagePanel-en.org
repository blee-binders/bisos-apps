...
* [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]] [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-apps/lcnt/bookPrintPublishing/_nodeBase_")][@ ~bookPrintPublishing~ @]]   ::  <<Book Print Publishing>> [[elisp:(org-cycle)][| *=* |]] [[elisp:(org-shifttab)][<)]] E|
####+END
