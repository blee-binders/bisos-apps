...
####+END
** +
** All things related to creation and edition of subtitles.
** B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "CSs -- Related to Subtitle -- Closed Caption " :anchor "" :extraInfo "Tools BinsPrep"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *CSs -- Related to Subtitle -- Closed Caption :* |]]  Tools BinsPrep  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
**  /bisos/core/lcnt/bin/subed-binsPrep.cs
** B|
...
####+BEGIN: blee:bxPanel:foldingSection :outLevel 2 :sep t :title "LCNT pnotes Aggregation" :anchor "pdfpc-notes" :extraInfo ".pdfpc"
** /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
** [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| /LCNT pnotes Aggregation:/ |]] <<pdfpc-notes>> .pdfpc  [[elisp:(org-shifttab)][<)]] E|
####+END
***  Just take the presentationEnFa.pdfpc
*** https://github.com/cebe/pdfpc-latex-notes
*** https://github.com/ronwzl/pnotes
*** Possible solution to fragile framenumber Bug -- https://github.com/josephwright/beamer/issues/450
*** -B|
...
** B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Embed VTT File" :anchor "convertedImage" :extraInfo "With ffmpeg --- mmUniteVideo.sh"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Embed VTT File:* |]] <<convertedImage>> With ffmpeg --- mmUniteVideo.sh  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
...
** B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Adding subtitles to Each Reveal.js Video" :anchor "" :extraInfo ""
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Adding subtitles to Each Reveal.js Video:* |]]    [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** https://stackoverflow.com/questions/21052156/how-to-add-subtitles-to-a-video-in-html
...
** B|
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Related but Unused" :anchor "" :extraInfo "Links"
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Related but Unused:* |]]  Links  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
** TODO https://github.com/jasonwebb/revealjs-subtitles   # Uses google's speach recognition with revealjs
** B|
