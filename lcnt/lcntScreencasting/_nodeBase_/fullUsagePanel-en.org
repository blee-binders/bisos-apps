...
####+END
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Control Of 4 Outputs And Derived Slide" :anchor "" :extraInfo "htmlonly, latexonly, articleMode, presentationMode."
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(outline-show-subtree+toggle)][| *Control Of 4 Outputs And Derived Slide:* |]]  htmlonly, latexonly, articleMode, presentationMode.  [[elisp:(org-shifttab)][<)]] E|
####+END
** +
